...
> **Historical cloud output.** This file was generated by the legacy all-call/tail
> estimator. Its accuracy and channel statistics remain useful, but its KL,
> divergence, and matched-length values are not directly comparable with corrected
> local Tier-2 results. Use REPORT_08 for current claims.
...
- **Table 3 is a legacy matched-prefix approximation.** It is selection-conditioned
  and cannot establish teacher-forced trajectory fidelity or a depth trend.
- **Table 1 TOST** needs adequate n to return EQUIVALENT within ±2pp; at small n
  ...
  evidence of harm. Larger paired samples are needed to test formal equivalence.
