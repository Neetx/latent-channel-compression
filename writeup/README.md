...
| canonical cloud Math500 ladder | [REPORT_06](../docs/reports/06_variant_b_in_loop_HEADLINE.md) |
| cloud controls and historical fidelity | [REPORT_07](../docs/reports/07_fidelity_sweep_modal.md) |
| four-cell local answer and corrected Tier-2 results | [REPORT_08](../docs/reports/08_local_cross_cell_generalization.md) |
